...
zzfxP = (...t) => {
    ...
    t.map((d, i) => f.getChannelData(i).set(d)), e.buffer = f, g = zzfxX.createGain(), g.gain.setValueAtTime(-0.8, zzfxX.currentTime), g.connect(zzfxX.destination), e.connect(g), e.connect(zzfxX.destination);
    return e
}
